...
const IntegrationSection = () => {
  ...
  const apiFeatures = [
    ...
    },
    {
      ...
      description: 'Comprehensive insights into recommendation performance, customer behavior, and business impact.',
      specs: ['Real-time metrics', 'Custom reports', 'A/B testing', 'ROI tracking']
    },
    {
      icon: Settings,
      title: 'Advanced Configuration',
      description: 'Flexible settings for occasion filters, style preferences, and custom business rules.',
      specs: ['Custom filters', 'Business rules', 'Style taxonomies', 'Preference weights']
    }
  ];
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {platforms.map((platform, index) => (
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-r from-yellow-500 to-yellow-700 rounded-xl flex items-center justify-center mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {apiFeatures.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white p-8 rounded-2xl border border-yellow-200/30 shadow-sm"
              >
